...
Now that we have interpreted the model using a -1 in the formula to get both a $\beta_1$ value and a $\beta_2$ value, let's take away the -1 and regress `alive_post` on and intercept and on `sex` to see how our equation changes.
