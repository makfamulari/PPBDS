...
<!-- MF: Necessary to re-explain stan_glm? Has this been done in earlier chapters? -->
...
<!-- MF: Do we need to add any additional sections to drive home the interactions explanation? Should I keep a separate interactions section dedicated to *just* studying interaction effects?-->
