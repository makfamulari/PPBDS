...
The average value of the difference in days-to-live is almost certainly positive, with the most likely value being around 4,500.


<!-- DK: Should we use posterior_linpred() or posterior_epred() here? We should certainly do more to show how to combine the original math with the model results. -->
...
In words, we would  expect the candidate from Washington to live longer than the South Dakota candidate. By how much? Well, that number is an unknown parameter. By looking at our posterior above, our best estimate is about 4,500 days, which is roughly 8 years. However, it is important to note that it is possible that the male from South Dakota could outlive the Washington male. In fact, there is a 1 in 5 chance that he does so.
