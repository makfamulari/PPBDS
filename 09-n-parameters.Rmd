...
There is a big overlap in the predictions for individuals, even though there is almost no overlap in the averages. Random stuff happens to an individual all the time. Random stuff cancels out when you take the average for many individuals. We can see that by looking at the difference in the posterior predictive distributions for the two individuals.
