...
* How do the `alive_post` values differ between two male political candidates, one from South Dakota and one from Washington, who are both 10 years older than the average candidate?
