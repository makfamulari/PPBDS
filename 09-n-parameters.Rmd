...
<!-- DK: Change axis labels to years? -->
...
ch9_gov %>% 
  ggplot(aes(x = alive_pre, y = alive_post)) +
    ...
    labs(title = "Longevity of Gubernatorial Candidates",
         ...
         x = "Age in Days (relative to average)",
...
<!-- DK: Add a discussion of what the intercept is? -->
