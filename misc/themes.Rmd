...
Key Question: Do Preceptor Tables belong under Wisdom or Justice?
...
Wisdom encompasses three issues: the map from concept to data (validity), the Preceptor Table, and the estimand. Maybe we should also discuss ethics? Not sure.
...
Second, use a Preceptor Table, remind readers what it is, and highlight how we begin by asking what would we know if we could know everything. Then, we show what we do, in fact, know. Inference is the procedure by which we replace the question marks.

Third, *estimands* are the thing we want to know. If we could see all possible numbers, calculating an estimand would be just a matter of arithmetic. 
