...
Third, *estimands* are the thing we want to know. If we could see all possible numbers, calculating an estimand would be just a matter of arithmetic. (It is somewhat weird to make that point before providing a Preceptor Table, but perhaps it is OK.)
