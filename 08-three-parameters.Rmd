...
Our second question was: What is the posterior probability distribution for the largest such effect when 3 people are exposed to the treatment?
...
posterior_predict(fit_obj, newdata = ate_data) %>%
  as_tibble() %>%
  setNames(c("Treated", "Control")) 
