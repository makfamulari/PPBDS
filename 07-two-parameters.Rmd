...
We have a model. What can we do with it? Let's revisit the three questions with which we started this section:
...
pp[, 1:100] %>% 
  ...
  ggplot(aes(x = third_tallest, y = after_stat(count / sum(count)))) +
    ...
    labs(title = "Posterior Probability of 3rd Tallest from One Hundreds",
         x = "Height (cm)",
         y = "Probability")
