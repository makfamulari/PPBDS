...
<!-- MF: Test to see if my git connection is working. -->
...
virtual_shovel %>% 
  mutate(is_red = (color == "red")) %>% 
  summarize(num_red = sum(is_red), .groups = FALSE)
```
...
### The Actual Preceptor Table: What We Know
...
### The Ideal Preceptor Table: What We Wish We Knew

As is the case in the RCM, we wish we knew the values for every single unit in every possible scenario. The analogous ideal here would be a tibble where we know the color identity of every single ball. To compare to our previous Preceptor Table, this is what we wish we knew in regards to our first 25 balls:
...
### The Reduced Preceptor Table

### The Prediction Preceptor Table
