...
```{r sampling-exercise-1, echo=FALSE, fig.cap="An urn with red and white balls.", out.width = "95%"}
...
```{r sampling-exercise-3b, echo=FALSE, fig.show='hold', fig.cap="Repeating sampling activity 33 times.", out.width = "30%"}
# Need new picture
...
```{r sampling-exercise-4, echo=FALSE, fig.cap="Constructing a histogram of proportions.", out.width = "80%"}
...
```{r sampling-exercise-5, echo=FALSE, fig.cap="Hand-drawn histogram of first 10 out of 33 proportions.", out.width = "70%"}
...
```{r three-shovels, echo=FALSE, fig.align='center', fig.cap="Three shovels to extract three different sample sizes.", out.width='100%'}
