...
<!-- DK: Why does this video fail? -->

```{r, echo=FALSE}
knitr::include_app("https://www.youtube.com/watch?v=e3PJ3Du_zDc")
```

This scene is from the popular YA series, *The Hunger Games*, a dystopian novel in which children are selected via a lottery to fight to the death. The basic elements of this event, called the "Reaping", are:
