...
```{r, echo=FALSE}
knitr::include_app("https://www.youtube.com/watch?v=v98Rh9qzmPs")
```

This scene is from the popular YA series, *The Hunger Games*, written by Suzanne Collins. *The Hunger Games*, for those unfamiliar, is a dystopian novel in which children are selected from a lottery to fight to the death. The basic elements of this event, called the "Reaping", are:
