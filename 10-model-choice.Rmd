...
<!-- DK: Can we get rid of bake()? Seems uncessesary. Just create a recipe and then put it into your workflow. -->
...
There are many models we could make to explain a given outcome variable. The chapter provides the tools for exploring which model we "ought" to use. We will use these tools in Chapters \@ref(continuous-response) (for continuous outcomes) and \@ref(discrete-response) (for discrete outcomes).
