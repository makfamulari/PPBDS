...
<!-- DK: Drop first fit section and working with fitted objects. Wait for fit_resamples() to discuss fitting? -->
...
`geom_abine()` draws the line at the 45 degree line. `coord_obs_pred()` is a function from **tidymodels** for making comparisons between actual with predicted values.
...
<!-- DK: I am confused about keep_pred and what it does in this code. Recall that there used to be stand-alone function defined at the top of the Rmd called keep_pred. I deleted it everywhere I found it and replaced it with control_resamples(save_pred = TRUE). Necessary? Desirable? -->
