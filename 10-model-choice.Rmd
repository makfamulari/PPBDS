...
Fourth, assign this pipe to a single workflow object. This object can then be used in several different ways. The best way to name this object is to include the letters `wfl` so as to rememeber that it is a workflow object.
...
This is the most important tool for deciding which model we should choose.
