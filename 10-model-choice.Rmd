...
<!-- DK: Get rid of remove_recipe(). Deal with keep_pred.  -->
...
`add_model()` and  `add_recipe()` are examples of some of the helper functions which are available in **tidymodels**. The goal is to make modeling as easy as basic data analysis, as in the Tidyverse.
